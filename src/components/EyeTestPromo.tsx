...
export default function EyeTestPromo() {
  return (
    <section id="eye-test" className="py-20 sm:py-28 px-6 sm:px-10 lg:px-14 bg-neutral-50/80">
      <div className="w-full max-w-[1500px] mx-auto">
        <div className="bg-white rounded-3xl border border-neutral-200/90 shadow-card p-8 sm:p-14 lg:p-18 overflow-hidden relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            {/* Left Column */}
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 text-accent text-xs font-bold uppercase tracking-wider mb-6">
                <Sparkles className="w-4 h-4" />
                <span>Complimentary In-Store Service</span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-sans font-extrabold text-neutral-900 tracking-tight leading-tight mb-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-accent hover:bg-accent-hover text-white text-xs sm:text-sm font-bold uppercase tracking-wider transition-colors duration-200 shadow-md"
                >
                  <span>Book Free Test on WhatsApp</span>
                  <ArrowUpRight className="w-4 h-4" />
                </a>

                <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-neutral-700 py-3 px-5 rounded-full bg-neutral-100 border border-neutral-200">
