...
export default function DualBanner() {
  return (
    <section className="py-12 sm:py-16 px-6 sm:px-10 lg:px-14 bg-white">
      <div className="w-full max-w-[1500px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
        {/* Banner 1: Prescription Glasses with Indian Woman in Glasses */}
        <div className="relative rounded-3xl overflow-hidden h-[500px] sm:h-[600px] lg:h-[660px] group bg-neutral-900 flex flex-col justify-end p-8 sm:p-14 lg:p-16 shadow-sm">
          <Image
